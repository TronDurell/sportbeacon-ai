 ...
 */
async function handleCheckoutSessionCompleted(session: CheckoutSessionData): Promise<boolean> {
  try {
 ...
 */
async function handlePaymentIntentSucceeded(paymentIntent: PaymentIntentData): Promise<boolean> {
  try {
 ...
 */
async function handlePaymentIntentFailed(paymentIntent: PaymentIntentData): Promise<boolean> {
  try {
    const { tipId } = paymentIntent.metadata;
 ...
 */
async function handlePayoutPaid(payout: PayoutData): Promise<boolean> {
  try {
 ...
 */
async function handlePayoutFailed(payout: PayoutData): Promise<boolean> {
  try {
    const { userId } = payout.metadata;
