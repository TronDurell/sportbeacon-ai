 ...
 */
exports.createStripeCheckoutSession = (0, https_1.onCall)(async (data, context) => {
    try {
        ...
        const checkoutSessionSchema = zod_1.z.object({
            ...
            toUserId: zod_1.z.string().uuid("Invalid recipient user ID").refine((val) => val !== fromUserId, "Cannot tip yourself"),
        ...
        const validation = validation_1.ValidationMiddleware.validateResponse(checkoutSessionSchema, data);
 ...
 */
exports.getCreatorTipStats = (0, https_1.onCall)(async (data, context) => {
    try {
        if (!context.auth) {
            return {
                error: {
