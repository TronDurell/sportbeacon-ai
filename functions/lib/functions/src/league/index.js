 ...
 */
exports.createLeague = (0, https_1.onCall)(async (data, context) => {
    try {
        const { auth } = await validateRecDirector(context);
        // Validate input using Zod schema
        const createLeagueSchema = zod_1.z.object({
            leagueData: validation_1.Schemas.CreateLeague
        });
        const validation = validation_1.ValidationMiddleware.validateResponse(createLeagueSchema, data);
 ...
 */
exports.updateLeague = (0, https_1.onCall)(async (data, context) => {
    try {
        const { auth } = await validateRecDirector(context);
 ...
 */
exports.getLeagueOverview = (0, https_1.onCall)(async (data, context) => {
    try {
 ...
 */
exports.getLeagueStandings = (0, https_1.onCall)(async (data, context) => {
    try {
        const auth = await validateAuth(context);
 ...
 */
exports.getLeagueSchedule = (0, https_1.onCall)(async (data, context) => {
    try {
        const auth = await validateAuth(context);
 ...
 */
exports.generateLeagueSchedule = (0, https_1.onCall)(async (data, context) => {
    try {
        const { auth } = await validateRecDirector(context);
 ...
 */
exports.getLeagueStatistics = (0, https_1.onCall)(async (data, context) => {
    try {
        const auth = await validateAuth(context);
