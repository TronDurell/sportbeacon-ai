...
import { AdminLeagueDashboardNative } from '../AdminLeagueDashboardNative';
...
// TODO: Skipped non-web test. This test used @testing-library/react-native and is not web-compatible.
test.skip('inclusionPolicy (native)', () => {
  // Skipped for web build
});
...
describe('ExceptionRequestModal', () => {
  ...
  describe('AdminLeagueDashboardNative', () => {
  const mockProps = {
    adminId: 'admin123'
  };
  ...
  it('renders correctly with tab navigation', () => {
    const { getByText } = render(
      <AdminLeagueDashboardNative {...mockProps} />
    );
