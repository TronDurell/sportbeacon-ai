...
import { collection, query, where, orderBy, limit, getDocs, doc, updateDoc, Timestamp, orderBy, addDoc } from "firebase/firestore";
...
export const AdminLeagueDashboardNative: React.FC<AdminLeagueDashboardProps> = ({
  adminId
}) => {
