...
jest.mock("../modules/AdminTools/RecAuditPanel", () => {
    ...
    const MockedRecAuditPanel = React.forwardRef((props, ref) => {
        ...
        if (!user.groups.includes("testGroups.caryAdminTest")) {
            return React.createElement("div", { "data-testid": "access-restricted" }, React.createElement("h2", null, "Access Restricted"), React.createElement("p", null, "You need Town Rec admin permissions to access this panel."));
        }
        return React.createElement("div", { "data-testid": "audit-panel" }, React.createElement("h1", null, "Town Rec Audit Panel"), React.createElement("p", null, "Town of Cary Parks & Recreation Administration"), React.createElement("div", { "data-testid": "waitlistExceptions" }, React.createElement("h3", null, "Waitlist Exceptions"), React.createElement("div", { "data-testid": "siblingPairing" }, "Sibling Pairing"), React.createElement("div", { "data-testid": "ageOverrideRequests" }, "Age Override Requests"), React.createElement("div", { "data-testid": "approvalQueue" }, "Approval Queue"), React.createElement("div", { "data-testid": "sandboxTestSubmit" }, "Sandbox Test Submit"), React.createElement("span", null, "PENDING"), React.createElement("span", null, "APPROVED"), React.createElement("span", null, "Sarah Johnson"), React.createElement("p", null, "Child is 4 months under age limit but shows advanced skills"), React.createElement("select", { defaultValue: "All" }), React.createElement("input", { placeholder: "Search" }), React.createElement("button", { "data-testid": "approve-button" }, "Approve"), React.createElement("button", { "data-testid": "deny-button" }, "Deny")));
    });
    return {
        __esModule: true,
