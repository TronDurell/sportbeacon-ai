...
describe('Admin Integration Tests', () => {
    ...
    describe('Queue Management', () => {
        it('should query pending verification items', async () => {
            ...
            // Query pending items
            const pendingQuery = query(collection(db, 'adminQueues/verification/items'), where('status', '==', 'pending'));
            ...
            const highPriorityQuery = query(collection(db, 'adminQueues/verification/items'), where('priority', '==', 'high'));
        ...
        it('should query pending dispute items', async () => {
            ...
            const pendingDisputesQuery = query(collection(db, 'adminQueues/dispute/items'), where('status', '==', 'pending'));
