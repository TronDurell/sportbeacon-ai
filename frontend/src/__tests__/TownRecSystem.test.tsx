...
describe('Town Rec System Integration Tests', () => {
  ...
  test('WaitlistManager integration', async () => {
    const { waitlistManager } = require('../../../lib/townRec/WaitlistManager');
  ...
  test('SiblingPairingQueue integration', async () => {
    const { siblingPairingQueue } = require('../../../lib/townRec/SiblingPairingQueue');
  ...
  test('TownStaffRole integration', () => {
    const { townStaffRole } = require('../../../lib/townRec/TownStaffRole');
