...
export const useErrorBoundary = (options = {}) => {
    const { maxErrors = 3, errorWindow = 60000, // 1 minute
    onError, context = "useErrorBoundary", autoRecover = false, recoveryDelay = 5000 // 5 seconds
     } = options;
    ...
    const isRecoverable = useCallback(() => {
        ...
        return recoverableErrors.some(errorType => state.error?.name === errorType ||
...
export const useApiErrorBoundary = (context) => {
...
export const useComponentErrorBoundary = (context) => {
    return useErrorBoundary({
        maxErrors: 3,
...
export const useFormErrorBoundary = (context) => {
    return useErrorBoundary({
        maxErrors: 10,
...
export const useNavigationErrorBoundary = (context) => {
    return useErrorBoundary({
        maxErrors: 2,
        errorWindow: 30000, // 30 seconds
...
// ============================================================================
export const createErrorRecoveryStrategy = (error, retryCount, maxRetries = 3) => {
