...
export const mockInsights = [
    {
        ...
        severity: 'HIGH',
        metric: 0.85,
        message: 'Sarah Thompson showing signs of fatigue after intense training sessions',
...
export const mockFeed = [
    ...
    },
    {
        ...
        content: 'David Chen achieved a new personal best in the Free Throw Challenge! 🎯',
    ...
    },
    {
        id: 'f3',
        type: 'team_update',
        content: 'Team practice scheduled for tomorrow at 3 PM. Focus: Zone Defense 🏃‍♂️',
