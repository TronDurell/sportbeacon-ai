...
// Simple icon component for the shield
...
// TODO: Web version of useShooterVerification not implemented. This is a stub to ensure web build passes.
const useShooterVerification = () => {
  // No-op for web
  return {};
};
export default useShooterVerification;
