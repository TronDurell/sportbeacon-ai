...
export const InsightCard: React.FC<InsightCardProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl shadow p-4 mb-2" role="region" aria-label="Insight card" tabIndex={0}>
      <Card
        variant="outlined"
        sx={{
          borderLeft: 3,
      ...
      >
        <CardContent>
          ...
          >
            ...
            <IconButton size="small" onClick={onAction} color="primary">
              <ActionIcon />
            </IconButton>
          </Box>
