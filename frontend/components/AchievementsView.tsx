...
export const AchievementsView: React.FC<AchievementsViewProps> = ({ playerId }) => {
            ...
            <Box mb={4}>
                ...
                {stats && (
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={4}>
                            <Card sx={{ p: 2, textAlign: 'center' }}>
                                <Typography variant="h6">{stats.total - stats.earned}</Typography>
                                <Typography variant="body2" color="text.secondary">
                                    Badges Remaining
                                </Typography>
                            </Card>
                                    ...
                                    >
                                        ...
                                        {!badge.earned && (
                                            <Typography
                                                ...
                                                sx={{ mt: 'auto' }}
                                            >
                                                Progress: {Math.round((badge.progress / badge.maxProgress) * 100)}%
                                            </Typography>
                                        )}
                                        {badge.earnedDate && (
                                            <Typography
